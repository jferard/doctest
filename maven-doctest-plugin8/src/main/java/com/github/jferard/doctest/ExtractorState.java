...
/**
 * A state in a finite machine state that extracts the examples
 */
interface ExtractorState {
	/**
	 * Process a line
	 * @param commentCodeExtractor the context
	 * @param line the line
	 */
	void process(CodeTagExtractor commentCodeExtractor, String line);
}
